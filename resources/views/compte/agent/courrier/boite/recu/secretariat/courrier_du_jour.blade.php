            ...
            <div class="nk-content-body">
                <div class="components-preview wide-md mx-auto">
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Courrier(s) reçu(s)   
                                ...
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            <li><a href="" class="btn btn-white btn-outline-light"><em class="icon ni ni-plus"></em><span>Liste des courriers imputer</span></a></li>
                    ...
                    <div class="nk-block nk-block-lg">
                      <form  action="{{route('courrier.selectCourrier')}}" method="POST">
                        @csrf
                        <input type="hidden" name="operation" value="imputation">
                            ...
                            <div class="card-inner">
                                <div class="nk-block-between-md g-3">
                                    ...
                                    <div class="g">
                                         ...
                                         <input  class="btn btn-light" type="submit" value="Imputer">
